...
public static class UserAttributesInfoManager
{
    ...
    public static readonly UserAttribute[] EditableAttributes = new[]
    {
        UserAttribute.PhoneNumber,
        UserAttribute.SessionEdit,
        UserAttribute.TgUsername,
    ...
    {
        UserAttributeInfoDict = new Dictionary<UserAttribute, UserAttributeInfo>
        {
            {
                UserAttribute.SessionAdd,
            ...
            },
            {
                ...
                new UserAttributeInfo(
                    ...
                    {
                        if (Regex.IsMatch(str,
                                @"^(add|remove)\s(0[1-9]|[12]\d|3[01])\.(0[1-9]|1[0-2])\.(19\d{2}|20\d{2})\s(0[1-9]|[12]\d|3[01])\.(0[1-9]|1[0-2])\.(19\d{2}|20\d{2})$"))
                        {
                            var splitted = str.Split(" ");
                ...
                new UserAttributeInfo(
                    ...
                    (UserDomain user, string message) =>
                    {
                        ...
                        else
                        {
                            ...
                            user.CounsellorInfo = new CounsellorInfo();
                        }
                    })
            },
            {
                ...
                new UserAttributeInfo(
                    ...
                    (UserDomain user, string message) => { user.PhoneNumber = message; })
            },
            {
                UserAttribute.FullName,
                new UserAttributeInfo(
                    ...
                    (UserDomain user, string message) =>
                    {
                        ...
                        user.FullName = new FullName(splittedMessage[0], splittedMessage[1],
                            splittedMessage.Length == 2 ? null : splittedMessage[2]);
                    })
            },
            {
                UserAttribute.TgUsername,
            ...
            },
            {
                ...
                new UserAttributeInfo(
                    ...
                    (user, message) => { user.Email = message == "_" ? null : message; })
            },
            {
                UserAttribute.Birthday,
                new UserAttributeInfo(
            ...
            },
            {
                ...
                new UserAttributeInfo(
                    ...
                    (user, message) => { user.City = message == "_" ? null : message; })
            },
            {
                UserAttribute.Group,
                new UserAttributeInfo(
            ...
            },
            {
                ...
                new UserAttributeInfo(
                    ...
                    {
                        user.ChildInfo!.EducationInfo = new EducationInfo()
                            { Class = user.ChildInfo!.EducationInfo!.Class, School = message };
                    })
            },
            {
                UserAttribute.Class,
    ...
    {
        return RolesAttributesDict[role].Contains(attribute);
    }
}